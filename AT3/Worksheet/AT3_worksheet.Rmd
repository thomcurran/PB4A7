...
We can visualize these distributions to get a better picture. But before we do that, lets just filter the GDP and GINI variables (we'll use GINI later) to get rid of the cases with missing values.
