...
Lets load the data into R. You add the anxiety data manually from the file pane or replace your file location in the code below:
...
The simplest way to do this is with Cronbach's alpha. Cronbach's alpha is loosely equivalent to splitting data in two in every possible way and computing the correlation coefficient for each split, and then compute the average of these values.
